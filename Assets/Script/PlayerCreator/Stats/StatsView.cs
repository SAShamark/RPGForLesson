...
namespace PlayerCreator.Stats
{
    public class StatsView : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            { new Stat(StatType.Agility, 2), new Stat(StatType.Intelligence, 1), new Stat(StatType.Strenght, 1) };
        ...
        private void UpdateStatViews()
        {
            foreach (var statViewData in _statViewsData)
            {
                ...
                statViewData.StatView.UpdateView(_freeStats > 0 &&
                    value<statViewData.StatView.MaxValue,value>statViewData.MinValue,value);
            }
        }
    }
}